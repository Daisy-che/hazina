...
const FAQSection: React.FC = () => {
  ...
  return (
    <section className="bg-gradient-to-b from-[#1e2836] via-purple-900 to-blue-600  to-gray-900 ">
  ...
  <div className="container mx-auto px-4 flex flex-wrap  space-y-6 md:space-y-0">
    ...
    <div className="w-full md:w-1/4">
      <h2 className="text-white text-2xl font-bold flex items-center">
        <Image src="/images/hazina-africa-logo.png" alt="Logo"width={200} height={200} className="w-60 h-10 mr-2" /> 
      </h2>
